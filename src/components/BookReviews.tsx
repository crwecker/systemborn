...
import { fetchUserBookReviews, createBookReview, updateBookReview, deleteBookReview } from '../services/api';
...
const BookReviews: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">My Book Reviews</h1>
      ...
      {reviews.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">You haven't written any book reviews yet.</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex space-x-3">
                        <button
                          ...
                          disabled={!editText.trim() || updateReviewMutation.isPending}
