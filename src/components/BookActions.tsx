    ...
    return (
      <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
        <p className='text-blue-800 text-center'>
          ...
          to add this book to your tier list or write a review
        </p>
      </div>
    )
  }
      ...
      {!existingTier && (
        <div className='bg-white border rounded-lg p-4'>
          ...
          <p className='text-sm text-gray-600 mt-2'>
            Add this book to your read collection, then organize it into tiers
            later from your Tier List page.
          </p>
        </div>
      )}
      ...
      <div className='bg-white border rounded-lg p-4'>
        ...
        {existingTier ? (
          <div className='flex items-center space-x-2'>
            ...
            <div
              className={`px-3 py-1 rounded-lg text-white font-bold text-sm ${TIER_CONFIG[existingTier.tier].color}`}>
          ...
          <div className='space-y-4'>
            ...
            <button
              ...
              {assignTierMutation.isPending
                ? 'Adding...'
                : `Add to ${TIER_CONFIG[selectedTier].name}`}
            </button>
          </div>
        )}
      </div>
