  ...
  return (
    <div className="min-h-screen bg-dark-blue text-white p-8 pt-32">
      <div className="max-w-md mx-auto bg-slate p-8 rounded-lg shadow-lg text-center">
        {status === 'verifying' && (
          <>
            <h1 className="text-3xl font-bold mb-4 text-copper">Verifying...</h1>
            <p className="text-light-gray">Please wait while we verify your magic link.</p>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-light-gray">You have been successfully signed in.</p>
            <p className="text-light-gray mt-2">Redirecting you to the homepage...</p>
          </>
        )}

        {status === 'error' && (
          <>
            <h1 className="text-3xl font-bold mb-4 text-copper">Verification Failed</h1>
